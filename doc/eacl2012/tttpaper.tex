...
\small
\hspace{1em}\texttt{(! (A \_*) (B \_* A \_*))}.  %corrected
\normalsize
...
{\bf Skolemization}:
%[SHOULD I MENTION EPILOG? -- it would compromise anonymity but if I'm using it here...]  LET'S SEE IF WE CAN DO WITHOUT THAT...
...
\bibitem[\protect\citename{Norvig}1991]{Norvig:2001}
Peter Norvig
\newblock 1991.
